    ...
    return (
        <div>
            ...
            <div className="top mb-5 px-5 mt-5">
                <div className=" bg-gray-900 py-5 border border-gray-500 rounded-lg">
                    <h1 className=" text-center text-2xl font-bold text-yellow-500">Admin Dashboard</h1>
                </div>
            </div>
            ...
            <div className="px-5">
                ...
                <div className="mid mb-5">
                    {/* main  */}
                    <div className=" bg-black py-5 rounded-xl border border-gray-500">
                        {/* image  */}
                    ...
                    <Tabs>
                        <TabList className="flex flex-wrap -m-4 text-center justify-center">
                            ...
                            <Tab className="p-4 md:w-1/3 sm:w-1/2 w-full cursor-pointer">
                                <div className=" border bg-black text-yellow-500 hover:bg-gray-900 border-gray-900 px-4 py-3 rounded-xl" >
